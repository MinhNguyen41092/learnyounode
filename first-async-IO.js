...
// can not return value from call back and print it to console
// because readFile is an async function, Node will execute below codes
// before the function is finished, therefore no value for the result
