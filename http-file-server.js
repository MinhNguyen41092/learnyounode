...
var server = http.createServer((request, response) => {
  // pipe(): read data from readable stream(file stream) and write it to
  // destination stream (server response)
  // fs.createReadStream(file_path): return a readable stream object, mean you can read
  // data from the file.
